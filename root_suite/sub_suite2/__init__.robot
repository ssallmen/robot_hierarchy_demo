*** Settings ***
Force Tags    sub_suite2
Suite Setup    Log Test Hierarchy Sub2 Variables
Suite Teardown    Log Test Hierarchy Sub2 Variables
...
*** Variables ***
${sub_suite2_var}    sub_suite2_value

*** Keywords ***
Log Test Hierarchy Sub2 Variables
    Log To Console    Running "Log Test Hierarchy Sub2 Variables" Suite setup
    My Own Keyword
    # Log To Console    sub_suite1_var=${sub_suite1_var}  # This would cause error "Variable '${sub_suite1_var}' not found."
    Log To Console    sub_suite2_var=${sub_suite2_var}
